...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Easier', 'than ever before, Just try it out', ]}>
            <Header index={'01'} title={'Select your Workout'} description={"Select the workout you wish to start with."} />
            ...
            <Header index={'02  '} title={'Set Your targets'} description={"Select the muscles judged for training."} />
            ...
            <Header index={'03'} title={'Become powerful, consistency is all you need'} description={"Select your Next objective."} />
